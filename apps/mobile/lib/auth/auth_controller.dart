...
class AuthScope extends InheritedNotifier<AuthController> {
  ...
  static AuthController of(BuildContext context) {
    ...
    assert(scope != null, 'AuthScope.of() called with a context that has no AuthScope.');
    return scope!.controller;
  }

  @override
  bool updateShouldNotify(covariant AuthScope oldWidget) => controller != oldWidget.controller;
}
